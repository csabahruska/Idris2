...
compile : Ref Ctxt Defs -> Ref Syn SyntaxInfo -> (tmpDir : String) -> (execDir : String) ->
        ClosedTerm -> (outfile : String) -> Core (Maybe String)
compile defs syn tmp dir term file = do
  coreLift $ putStrLn "I'd rather not."
  pure $ Nothing

execute : Ref Ctxt Defs -> Ref Syn SyntaxInfo -> (execDir : String) -> ClosedTerm -> Core ()
